# Manual Setup Steps for Minions Contracts
...
Go to **GitHub → mxn2020/minions-contracts → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-contracts` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-contracts-web`
- **GitHub repo**: `mxn2020/minions-contracts`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `contracts.minions.wtf`

### Documentation
- **Netlify site name**: `minions-contracts-docs`
- **GitHub repo**: `mxn2020/minions-contracts`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `contracts.minions.help`

### Blog
- **Netlify site name**: `minions-contracts-blog`
- **GitHub repo**: `mxn2020/minions-contracts`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `contracts.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `contracts.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `contracts.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `contracts.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-contracts/sdk`](https://www.npmjs.com/package/@minions-contracts/sdk)
- CLI: [`@minions-contracts/cli`](https://www.npmjs.com/package/@minions-contracts/cli)
...
Your package: [`minions-contracts`](https://pypi.org/project/minions-contracts/)
...
| Item | Value |
|------|-------|
| Project | `minions-contracts` |
| SDK (npm) | `@minions-contracts/sdk` |
| CLI (npm) | `@minions-contracts/cli` |
| Python (PyPI) | `minions-contracts` |
| GitHub | `github.com/mxn2020/minions-contracts` |
| Docs domain | `contracts.minions.help` |
| Blog domain | `contracts.minions.blog` |
| App domain | `contracts.minions.wtf` |
