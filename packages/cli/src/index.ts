...
/**
 * @minions-contracts/cli — CLI for Minions contracts
 *
...
import { customTypes } from '@minions-contracts/sdk';
...
program.name('contracts').description('Agreements, statements of work, terms, and signed documents').version('0.1.0');

program.command('info').description('Show project info').action(() => {
    console.log(chalk.bold('Minions contracts'));
    console.log(chalk.dim('Agreements, statements of work, terms, and signed documents'));
    console.log('');
    console.log(`  SDK:    ${chalk.cyan('@minions-contracts/sdk')}`);
    console.log(`  CLI:    ${chalk.cyan('@minions-contracts/cli')}`);
    console.log(`  Python: ${chalk.cyan('minions_contracts')}`);
